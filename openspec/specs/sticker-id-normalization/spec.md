# sticker-id-normalization Specification

## Purpose
Legacy synchronized capability specification for sticker-id-normalization.

## Requirements
### Requirement: sticker-id-normalization capability behavior
